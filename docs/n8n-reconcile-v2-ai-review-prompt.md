...
- Left-hand and right-hand items are different product identities. Do not group Hand L and Hand R lines together, even when width, height, quantity, unit price, or totals appear compatible.
...
- ENTRY_UNIT identity: width, height, thickness, core/material, style, prep, fire rating when present, and hand after entry-unit metal-hand logic.
...
- Exterior entry units with metal/Timely prep use reverse metal-hand logic: PO Hand L can match vendor RH METAL/RH STEEL, and PO Hand R can match vendor LH METAL/LH STEEL.
